...
def simulate(seed):
    ...
    # Calculate community facilitation metrics
    L_eff1 = param.calculate_effective_leakage(u1, l1)
    Facilitation1 = param.calculate_community_feedback(L_eff1, u1)
    
    L_eff2 = param.calculate_effective_leakage(u2, l2)
    Facilitation2 = param.calculate_community_feedback(L_eff2, u2)
    
    L_eff3 = param.calculate_effective_leakage(u3, l3)
    Facilitation3 = param.calculate_community_feedback(L_eff3, u3)
